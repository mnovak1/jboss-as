...
public class MessagingDependencies {
    ...
    static String getJGroupsGAV(String artifactId, ModelTestControllerVersion version) {
        switch (version) {
            case EAP_7_0_0:
                return "org.jboss.eap:" + artifactId + ":" + version.getMavenGavVersion();
            case WF_11_0_0_CR1:
            default:
                return "org.wildfly:" + artifactId + ":" + version.getMavenGavVersion();
        }
    }
}
